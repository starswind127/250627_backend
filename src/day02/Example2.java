...
public class Example2 {
    public static void main(String[] args) {
        //입력 함수 : 콘솔화면에서 키보드로부터 입력받은 방법
        // 1. new Scanner( System.in); 시스템(컴퓨터)로 부터 입력받은 기능(함수 )를 제공하는 객체
        // 2. 종류
        //          .next() : 키보드로부터 입력받은 문자열 반환 , 단 ] 띄어쓰기 불가능
        //          .nextLine() : 입력받은 문자열 반환 단] 띄어쓰기 가능
...
//        new Scanner( System.in).next();
        ...
        String str1 = scan.next(); // == new Scanner(Systemin).next();
        System.out.println("1. next result : "+ str1);

        //2. nextLine()
        System.out.print("2. nextLine");
        scan.next(); // 무의미한 next, nextLine()문제점 해결
        ...
        //7. nextFlote();
        System.out.print("7. nextFlote()");
        float value5 = scan.nextFloat();
        System.out.println("7. nextFlote() result : "+ value5);
        ...
        // 10. next().charAt( 0 ); : 입력받은 문자열중 첫번째 글자1개 (char) 반환,* nextChar는 없다.
